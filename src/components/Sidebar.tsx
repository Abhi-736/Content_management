...
const Sidebar = () => {
  ...
  return (
    <div className={`h-screen fixed top-0 bottom-0 left-0 z-10 w-1/4 bg-slate-500 flex transition-all ${isOpen?'transform translate-x-0':'transform translate-x-[-90%]'}  `}>
